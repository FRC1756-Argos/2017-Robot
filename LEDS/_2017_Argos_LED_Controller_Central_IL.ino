...
#define DATAPIN3    4 // turret leds
#define CLOCKPIN3   3 // turret leds
#define DATAPIN4    10 // turret leds
#define CLOCKPIN4   11 // turret leds
...
CRGB leds_front[NUM_LEDS_FRONT]; //setup array for side leds
...
{ 
  ...
  else //if (( led_side_cursor < NUM_LEDS_SIDE) && (dir_side == 'B'))
   {
  ...
  else if (led_front_cursor == NUM_LEDS_FRONT)
  {
     dir_front = 'B';
  ...
  else //if (led_turret_cursor == NUM_LEDS_TUR)
  {
     dir_tur = 'B';
 ...
 // }
  ...
  {
   leds_tur_left[i] = turretColor;
  }
  //Blink Turret LEDS when shoot button is pressed
  if (shoot == 'E')
  {
    for (int i = 0; i < NUM_LEDS_TUR; i++)
    {
